...
nmax = 1000  # -1 is the same as no nmax 
maf_thresh = 0.05
```
...
cohort.1 <- map_cohort(files, "COVID_ICU", maf_thresh=0.05, nmax = 1000)
...
cohort.2 <- map_cohort(files, "COVID_NEG", maf_thresh = 0.05, nmax = 1000)
...
cohort.3 <- map_cohort(files, "COVID_INPAT", maf_thresh = 0.05, nmax = 1000)
...
cohort.4 <- map_cohort(files, "COVID_OUTPAT", maf_thresh = 0.05, nmax = 1000)
